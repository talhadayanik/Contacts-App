...
class FamilyFragment : Fragment() {
    ...
    lateinit var listFamily : ListView
    ...
    override fun onCreateView(
        ...
        val view: View = (activityContext as Activity).layoutInflater.inflate(R.layout.fragment_family, null, true)

        listFamily = view.findViewById(R.id.listFamily)
        contactList = mutableListOf()

        val contactAdapter = ContactAdapter(requireContext(),contactList)
        listFamily.adapter = contactAdapter

        listFamily.setOnItemClickListener { parent, view, position, id ->
    ...
    suspend fun getData() = withContext(Dispatchers.IO){
        MainActivity.db.contactDao().getDataByGroup("Family")
    }
}